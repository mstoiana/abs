standardize_ASGS <- function(base_path) {
  ...
  source(scripts_path)
  dest_path <- here("Classifications", "LOCATION_ASGS", "Download")
  extract_path <- here("Classifications", "LOCATION_ASGS", "Input")

  url_from_excel(here("Classifications", "LOCATION_ASGS", "Download", "MB_Data_source.xlsx"), dest_path, extract_path)
  url_from_excel(here("Classifications", "LOCATION_ASGS", "Download", "LGA_Data_source.xlsx"), dest_path, extract_path)
#import all states meshblock lists
  NSW <- read_csv(here("Classifications", "LOCATION_ASGS", "Input", "MB_2016_NSW.csv"))
  VIC <- read_csv(here("Classifications", "LOCATION_ASGS", "Input", "MB_2016_VIC.csv"))
  QLD <- read_csv(here("Classifications", "LOCATION_ASGS", "Input", "MB_2016_QLD.csv"))
  SA <- read_csv(here("Classifications", "LOCATION_ASGS", "Input", "MB_2016_SA.csv"))
  WA <- read_csv(here("Classifications", "LOCATION_ASGS", "Input", "MB_2016_WA.csv"))
  TAS <- read_csv(here("Classifications", "LOCATION_ASGS", "Input", "MB_2016_TAS.csv"))
  NT <- read_csv(here("Classifications", "LOCATION_ASGS", "Input", "MB_2016_NT.csv"))
  ACT <- read_csv(here("Classifications", "LOCATION_ASGS", "Input", "MB_2016_ACT.csv"))
  OT <- read_csv(here("Classifications", "LOCATION_ASGS", "Input", "MB_2016_OT.csv"))

#import all LGA lists
  LGA_NSW <- read_csv(here("Classifications", "LOCATION_ASGS", "Input", "LGA_2020_NSW.csv"))
  LGA_VIC <- read_csv(here("Classifications", "LOCATION_ASGS", "Input", "LGA_2020_VIC.csv"))
  LGA_QLD <- read_csv(here("Classifications", "LOCATION_ASGS", "Input", "LGA_2020_QLD.csv"))
  LGA_SA <- read_csv(here("Classifications", "LOCATION_ASGS", "Input", "LGA_2020_SA.csv"))
  LGA_WA <- read_csv(here("Classifications", "LOCATION_ASGS", "Input", "LGA_2020_WA.csv"))
  LGA_TAS <- read_csv(here("Classifications", "LOCATION_ASGS", "Input", "LGA_2020_TAS.csv"))
  LGA_NT <- read_csv(here("Classifications", "LOCATION_ASGS", "Input", "LGA_2020_NT.csv"))
  LGA_ACT <- read_csv(here("Classifications", "LOCATION_ASGS", "Input", "LGA_2020_ACT.csv"))
  LGA_OT <- read_csv(here("Classifications", "LOCATION_ASGS", "Input", "LGA_2020_OT.csv"))

#Import non abs data
  UCL_Data <- read_csv(here("Classifications", "LOCATION_ASGS", "Input", "SA1_UCL_SOSR_SOS_2016_AUST.csv"))
  SUA_Data <- read_csv(here("Classifications", "LOCATION_ASGS", "Input", "SA2_SUA_2016_AUST.csv"))
...
#write to CSV
  write_csv(LGA, here("Classifications", "LOCATION_ASGS", "Output", "ASGS_LGA.csv"))
  write_csv(SA1, here("Classifications", "LOCATION_ASGS", "Output", "ASGS_SA1.csv"))
  write_csv(SA2, here("Classifications", "LOCATION_ASGS", "Output", "ASGS_SA2.csv"))
  write_csv(SA3, here("Classifications", "LOCATION_ASGS", "Output", "ASGS_SA3.csv"))
  write_csv(SA4, here("Classifications", "LOCATION_ASGS", "Output", "ASGS_SA4.csv"))
  write_csv(GCCSA, here("Classifications", "LOCATION_ASGS", "Output", "ASGS_GCCSA.csv"))
  write_csv(State, here("Classifications", "LOCATION_ASGS", "Output", "ASGS_State.csv"))
  write_csv(SA1_UCL, here("Classifications", "LOCATION_ASGS", "Output", "ASGS_SA1_UCL.csv"))
  write_csv(SA2_SUA, here("Classifications", "LOCATION_ASGS", "Output", "ASGS_SA2_SUA.csv"))
  write_csv(SOSR, here("Classifications", "LOCATION_ASGS", "Output", "ASGS_SOSR.csv"))
  write_csv(Meshblock, here("Classifications", "LOCATION_ASGS", "Output", "ASGS_Meshblock.csv"))
